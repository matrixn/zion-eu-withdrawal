...
final class SettingsPage
{
    ...
    public function enqueue_assets(string $hook): void
    {
        ...
        wp_localize_script('zion-eu-withdrawal-admin', 'ZionEuWithdrawalAdmin', [
            ...
            'adminNonce' => wp_create_nonce('zion_eu_withdrawal_admin'),
    ...
    {
        return [
            'default_eligibility_rule' => ['section' => 'eligibility', 'type' => 'select', 'options' => ['standard' => ['ro' => 'Regula standard', 'en' => 'Standard rule'], 'potential_exception' => ['ro' => 'Posibila exceptie legala', 'en' => 'Potential statutory exception'], 'unknown' => ['ro' => 'Necunoscut - verificare manuala', 'en' => 'Unknown - manual review']], 'ro' => 'Regula implicita pentru produse', 'en' => 'Default product eligibility rule', 'description_ro' => 'Clasificarea de baza folosita cand produsul si categoria nu au o suprascriere.', 'description_en' => 'Base classification used when neither the product nor category has an override.'],
            'unknown_delivery_behavior' => ['section' => 'eligibility', 'type' => 'select', 'options' => ['record_unknown' => ['ro' => 'Marcheaza necunoscut si nu bloca', 'en' => 'Record unknown and do not block'], 'merchant_review' => ['ro' => 'Trimite la verificare comerciant', 'en' => 'Send to merchant review']], 'ro' => 'Comportament pentru data livrarii necunoscuta', 'en' => 'Unknown delivery date behaviour', 'description_ro' => 'Cand nu exista o data de livrare verificabila, cererea ramane posibila si este marcata pentru verificare.', 'description_en' => 'When no verifiable delivery date exists, submission remains possible and is marked for review.'],
            'delivery_date_meta_key' => ['section' => 'eligibility', 'type' => 'text', 'ro' => 'Cheie meta pentru data livrarii', 'en' => 'Delivery date meta key', 'description_ro' => 'Cheia meta WooCommerce in care integratorul de livrare poate salva data fizica a livrarii. Nu folosim data comenzii ca substitut.', 'description_en' => 'WooCommerce order meta key where a delivery integration can save the physical delivery date. The order date is never used as a substitute.'],
            'admin_recipients' => ['section' => 'notifications', 'type' => 'textarea', 'ro' => 'Destinatari interni suplimentari', 'en' => 'Additional internal recipients', 'description_ro' => 'Adrese separate prin virgula, punct si virgula sau spatiu pentru notificarile comerciantului.', 'description_en' => 'Addresses separated by comma, semicolon or whitespace for merchant notifications.'],
            'consumer_email_subject' => ['section' => 'notifications', 'type' => 'text', 'ro' => 'Subiect confirmare client', 'en' => 'Consumer confirmation subject', 'description_ro' => 'Subiectul e-mailului de dovada trimis clientului. Poti folosi variabila {withdrawal_id}.', 'description_en' => 'Proof e-mail subject sent to the customer. You can use the {withdrawal_id} variable.'],
            'admin_email_subject' => ['section' => 'notifications', 'type' => 'text', 'ro' => 'Subiect notificare comerciant', 'en' => 'Merchant notification subject', 'description_ro' => 'Subiectul notificarii interne. Poti folosi variabila {withdrawal_id}.', 'description_en' => 'Internal notification subject. You can use the {withdrawal_id} variable.'],
            'notification_log_retention_days' => ['section' => 'notifications', 'type' => 'number', 'min' => 30, 'max' => 3650, 'ro' => 'Pastrare log notificari (zile)', 'en' => 'Notification log retention (days)', 'description_ro' => 'Perioada operationala pentru logurile de e-mail; snapshot-urile retragerilor raman separat.', 'description_en' => 'Operational period for e-mail logs; withdrawal snapshots remain separate.'],
            'checkout_disclosure_enabled' => ['section' => 'checkout', 'type' => 'checkbox', 'ro' => 'Afiseaza informarea in checkout', 'en' => 'Show checkout disclosure', 'description_ro' => 'Afiseaza un text clar despre dreptul de retragere si linkul functiei online in checkout.', 'description_en' => 'Show clear withdrawal-right information and the online function link in checkout.'],
            'checkout_disclosure_position' => ['section' => 'checkout', 'type' => 'select', 'options' => ['before_form' => ['ro' => 'Inaintea formularului', 'en' => 'Before checkout form'], 'before_submit' => ['ro' => 'Langa butonul de comanda', 'en' => 'Near place order button'], 'after_notes' => ['ro' => 'Dupa notele comenzii', 'en' => 'After order notes']], 'ro' => 'Pozitie informare checkout', 'en' => 'Checkout disclosure position', 'description_ro' => 'Alege locul in care mesajul apare in checkout-ul clasic WooCommerce.', 'description_en' => 'Choose where the message appears in the classic WooCommerce checkout.'],
            'checkout_disclosure_title' => ['section' => 'checkout', 'type' => 'text', 'ro' => 'Titlu informare checkout', 'en' => 'Checkout disclosure title', 'description_ro' => 'Titlul vizibil inainte de confirmarea comenzii.', 'description_en' => 'Title visible before order confirmation.'],
            'checkout_disclosure_text' => ['section' => 'checkout', 'type' => 'textarea', 'ro' => 'Text informare checkout', 'en' => 'Checkout disclosure text', 'description_ro' => 'Textul standard despre dreptul de retragere. Pastreaza formularea clara si fara ambiguitati.', 'description_en' => 'Standard withdrawal-right text. Keep the wording clear and unambiguous.'],
            'order_confirmation_disclosure' => ['section' => 'checkout', 'type' => 'checkbox', 'ro' => 'Adauga link in confirmarea comenzii', 'en' => 'Add link to order confirmation', 'description_ro' => 'Adauga linkul catre functia online in pagina de multumire si e-mailurile WooCommerce.', 'description_en' => 'Add the online function link to the thank-you page and WooCommerce e-mails.'],
            ...
            'withdrawal_page_id' => ['section' => 'experience', 'type' => 'text', 'readonly' => true, 'ro' => 'ID pagină creată automat', 'en' => 'Automatically created page ID', 'description_ro' => 'ID-ul paginii publice creată de plugin. Câmpul este read-only și te ajută să verifici rapid legătura cu WordPress.', 'description_en' => 'The ID of the public page created by the plugin. Read-only so you can quickly verify the WordPress connection.'],
    ...
    {
        return [
            'eligibility' => ['number' => '05', 'ro' => 'Eligibilitate si livrare', 'en' => 'Eligibility and delivery', 'description_ro' => 'Motor orientativ pentru reguli de produs, categorii si data livrarii.', 'description_en' => 'Indicative engine for product, category and delivery-date rules.'],
            'checkout' => ['number' => '06', 'ro' => 'Informare in checkout', 'en' => 'Checkout disclosure', 'description_ro' => 'Informarea precontractuala si linkul catre functia online de retragere.', 'description_en' => 'Pre-contract information and the link to the online withdrawal function.'],
    ...
    private function render_field(string $key, array $field): void
    {
        ...
        <div class="zion-eu-field zion-eu-field--<?php echo esc_attr($type); ?>" data-setting-row="<?php echo esc_attr($key); ?>">
            ...
            <div class="zion-eu-field-control">
                ...
                <?php elseif ($type === 'textarea') : ?><textarea id="<?php echo esc_attr($field_id); ?>" data-zion-setting="<?php echo esc_attr($key); ?>" rows="4"><?php echo esc_textarea((string) $value); ?></textarea>
